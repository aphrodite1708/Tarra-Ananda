const LINKS = [
  {
    icon: '💼',
    label: 'LinkedIn',
    value: 'tarra-ananda777',
    href: 'https://www.linkedin.com/in/tarra-ananda777/',
  },
  {
    icon: '✈️',
    label: 'Telegram',
    value: '@aphroditestea',
    href: 'https://t.me/aphroditestea',
  },
  {
    icon: '📧',
    label: 'Email',
    value: 'tarranandava@gmail.com',
    href: 'mailto:tarranandava@gmail.com',
  },
  {
    icon: '📱',
    label: 'WhatsApp',
    value: '+62 812-8630-2213',
    href: 'https://wa.me/6281286302213',
  },
]
